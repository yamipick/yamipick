...
public class QBanner extends EntityPathBase<Banner> {
    ...
    private static final long serialVersionUID = 1529475900L;

    public static final QBanner banner = new QBanner("banner");

    public final StringPath imgPath = createString("imgPath");

    public final StringPath isVisible = createString("isVisible");

    public final NumberPath<Long> seqBanner = createNumber("seqBanner", Long.class);
